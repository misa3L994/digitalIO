...
#ifndef proyectil_BUZZER_H_
#define proyectil_BUZZER_H_
#include <Arduino.h>
...
const int wrong[] = {
  NOTE_C3, NOTE_C3, NOTE_C3 // WRONG
};
//NOTE_C5, NOTE_C5, NOTE_D5, 0, NOTE_D5 // WIN
const int level_up[] = {
  NOTE_G5, NOTE_E6, NOTE_G6,
  NOTE_A6, //0, NOTE_F6, NOTE_G6,
  //0, NOTE_E6, 0, NOTE_C6,
...
const int wins[] = {
  //NOTE_C6, 0, 0, NOTE_G5,
  //0, 0, NOTE_E5, 0,
  NOTE_G6, NOTE_A6, NOTE_B6, NOTE_C7,
  //NOTE_F5, //NOTE_AS5, NOTE_A5, 0,
};
const int tempoW[] = {
  //9, 9, 9, 9,
  //12, 12, 12, 12,
